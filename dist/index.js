...
var TeleportGeneratorNuxt = /** @class */ (function (_super) {
    __extends(TeleportGeneratorNuxt, _super);
    function TeleportGeneratorNuxt() {
        var _this = _super.call(this, 'nuxt-generator', 'nuxt') || this;
    ...
    TeleportGeneratorNuxt.prototype.generateComponent = function (component, options) {
        return this.componentGenerator.generate(component, options);
    };
    TeleportGeneratorNuxt.prototype.generateProject = function (component, options) {
        return this.projectGenerator.generate(component, options);
    };
    return TeleportGeneratorNuxt;
}(teleport_lib_js_1.Generator));
exports.default = TeleportGeneratorNuxt;
