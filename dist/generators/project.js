...
var NuxtProjectGenerator = /** @class */ (function (_super) {
    __extends(NuxtProjectGenerator, _super);
    function NuxtProjectGenerator(generator, componentGenerator) {
        var _this = _super.call(this, generator) || this;
        _this.componentGenerator = componentGenerator;
        return _this;
    }
    NuxtProjectGenerator.prototype.generate = function (project, options) {
        var _this = this;
    ...
    NuxtProjectGenerator.prototype.publish = function (path, archive) {
        if (archive === void 0) { archive = false; }
    };
    return NuxtProjectGenerator;
}(teleport_lib_js_1.ProjectGenerator));
exports.default = NuxtProjectGenerator;
